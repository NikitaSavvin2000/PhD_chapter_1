...
<p align="center">
  <img src="./images/Istanbul_Traffic_Index_gap_50_experiment_0_en.png" width="50%" alt="Рис. 1">
</p>
...
**Шаг 4.** Значения, принадлежащие выбранным интервалам, удалялись из временного ряда. Ппример формирования 10% пропусков на датасете Elista (эксперимент 0) представлено на рисунке 1.



**Шаг 5.** Полученный ряд с пропусками восстанавливался всеми рассматриваемыми методами. Пример результата восстановления пропусков для датасета Elista при уровне 10% (эксперимент 0) с использованием методов AIM и PFBGB приведены на рисунках 2 и 3 соответственно.
...
**Шаг 6.** Для восстановленного ряда рассчитывались показатели качества заполнения, после чего результаты сохранялись для последующего анализа.
